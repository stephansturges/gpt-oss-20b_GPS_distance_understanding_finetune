...
python3 run_eval_transformers_noharmony.py   --eval-file eval_set.parquet   --model openai/gpt-oss-20b   --out eval_results.parquet   --summary eval_summary.json   --effort high --max-new-tokens 2000 --decoding deterministic --verbose --log eval_run_high.txt --batch-size 8 --chat-format harmony
